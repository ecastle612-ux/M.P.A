...
import { adjustInventoryInputSchema } from "@mpa/shared";
import { requireFacilityPermission } from "../../../../../lib/facility/authz";
import { adjustInventory } from "../../../../../lib/facility/inventory-service";
...
export async function POST(request: Request) {
  ...
  try {
    const input = adjustInventoryInputSchema.parse(await request.json());

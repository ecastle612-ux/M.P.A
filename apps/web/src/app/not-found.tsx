...
import { BrandSurfaceTone } from "../components/branding/brand-surface-tone";
...
export default async function NotFoundPage() {
  ...
  const tone = brandSurfaceToneForMode(theme.mode);

  return (
    <BrandSurfaceTone tone={tone}>
      <main
        data-brand-surface={tone}
        className="flex min-h-screen items-center justify-center bg-[var(--mpa-color-bg-app)] p-4"
      >

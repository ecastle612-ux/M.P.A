...
const NAV_ITEMS = [
  { id: "nav-dashboard", label: "Open Dashboard", href: "/dashboard", shortcut: "G D", icon: "⌁" },
  { id: "nav-ops-inbox", label: "Open My Work", href: "/inbox", shortcut: null, icon: "→" },
  { id: "nav-activity", label: "Open Activity", href: "/activity", shortcut: null, icon: "→" },
  { id: "nav-properties", label: "Open Property Operations", href: "/properties", shortcut: "G P", icon: "→" },
  { id: "nav-units", label: "Open Units", href: "/units", shortcut: "G U", icon: "→" },
  { id: "nav-applicants", label: "Open Applicants", href: "/applicants", shortcut: "G A", icon: "→" },
  { id: "nav-tenants", label: "Open Residents", href: "/tenants", shortcut: "G T", icon: "→" },
  ...
  { id: "nav-leases", label: "Open Leasing", href: "/leases", shortcut: "G L", icon: "→" },
  { id: "nav-inbox", label: "Open Messages", href: "/communications/inbox", shortcut: "G I", icon: "→" },
  { id: "nav-communications", label: "Open Announcements", href: "/communications", shortcut: "G C", icon: "→" },
  { id: "nav-financials", label: "Open Accounting", href: "/financials", shortcut: "G F", icon: "→" },
  { id: "nav-documents", label: "Open Document Vault", href: "/settings/documents", shortcut: null, icon: "→" },
  { id: "nav-ai-operations", label: "Open Performance", href: "/ai-operations", shortcut: "G Q", icon: "→" },
  { id: "nav-maintenance", label: "Open Maintenance", href: "/maintenance", shortcut: "G M", icon: "→" },
  { id: "nav-vendors", label: "Open Vendors", href: "/vendors", shortcut: "G V", icon: "→" },
  { id: "nav-migration", label: "Continue Migration", href: "/migration", shortcut: null, icon: "→" },
  { id: "nav-profile", label: "Open Profile", href: "/profile", shortcut: null, icon: "→" },
  { id: "nav-portals", label: "Open Portals", href: "/portal", shortcut: null, icon: "→" },
  { id: "nav-settings-team", label: "Invite User", href: "/settings/team", shortcut: null, icon: "+" }
] as const;
...
function buildActionItems(permissions: readonly string[]): CommandCenterResult[] {
  ...
  if (evaluateCapability(permissions, "tenant:create")) {
    items.push({
      ...
      category: "actions",
      label: "Add Resident",
      subtitle: "Create a resident record",
      context: "Residents",
      badge: "Create",
      status: "Quick",
      statusVariant: "info",

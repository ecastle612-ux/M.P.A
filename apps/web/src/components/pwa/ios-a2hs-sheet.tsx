...
export function IosA2hsSheet({
  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-[var(--mpa-radius-lg)] border border-[var(--mpa-color-border-subtle)] bg-[var(--mpa-color-bg-surface)] p-[var(--mpa-space-5)] shadow-[var(--mpa-shadow-lg)]">
        <h2
          id="ios-a2hs-title"

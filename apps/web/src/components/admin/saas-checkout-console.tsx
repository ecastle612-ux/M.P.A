    ...
    <main className="space-y-6 p-4 md:p-6">
      <header className="space-y-2">
        ...
        <p className="max-w-3xl text-sm text-[var(--mpa-color-text-secondary)]">
          COM-002 Slice C verification — Stripe SaaS Checkout for Property Manager Monthly / Annual
          (approved three-module model). Automatic provisioning is Slice D (see Commercial →
          Provisioning).
        </p>

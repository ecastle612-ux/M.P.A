...
export const NAV_ICON_MAP: Record<string, ComponentType<IconProps>> = {
  ...
  "/financials/payments": NavIconFinancials,
  "/financials/expenses": NavIconFinancials,
  "/financials/owner-statements": NavIconFinancials,
  "/financials/reports": NavIconFinancials,
  "/ai-operations": NavIconAi,
  "/migration": NavIconMigration,
  "/settings": NavIconSettings,
  "/settings/organization": NavIconSettings,
  ...
  "/master-admin/recovery": NavIconMaintenance,
  "/master-admin/commercial": NavIconFinancials,
  ...
  "/facility/reports": NavIconDashboard,

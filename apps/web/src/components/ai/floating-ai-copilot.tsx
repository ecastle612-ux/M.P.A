...
export const FloatingAiCopilot = memo(function FloatingAiCopilot() {
  ...
  const panel = (
    <div
      className="pointer-events-none fixed bottom-[calc(4.5rem+var(--mpa-safe-bottom)+var(--mpa-keyboard-inset,0px))] right-4 z-[100] flex flex-col items-end gap-3 md:bottom-[calc(1.5rem+var(--mpa-safe-bottom)+var(--mpa-keyboard-inset,0px))]"

...
export const MARKETING_MODULE_COPY: Record<string, string> = {
  ...
  financial_operations:
    "Take rent online with Stripe. Tenants can pay a posted balance once, or turn on AutoPay for recurring rent and eligible fees. You set every amount. Late fees are configured and posted by you, not assessed automatically.",

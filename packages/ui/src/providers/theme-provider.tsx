...
const lightThemeVariables: Record<string, string> = {
  ...
  "--mpa-color-text-tertiary": canopyTokens.color.text.muted,
  ...
  "--mpa-color-brand": canopyTokens.color.brand.primary,
  "--mpa-color-action-primary": canopyTokens.color.brand.primary,
  "--mpa-color-surface-muted": canopyTokens.color.bg.surfaceMuted,
  "--mpa-color-border": canopyTokens.color.border.default,
...
const darkThemeVariables: Record<string, string> = {
  ...
  "--mpa-color-text-tertiary": "#94A3B8",
  ...
  "--mpa-color-brand": "#1FA87A",
  "--mpa-color-action-primary": "#1FA87A",
  "--mpa-color-surface-muted": "#1B2028",
  "--mpa-color-border": "#2A313C",

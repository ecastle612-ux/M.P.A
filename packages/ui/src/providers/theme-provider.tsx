...
export function ThemeProvider({
  ...
  const cssVariables: Record<string, string> = {
    ...
    "--mpa-color-bg-sidebar-active": canopyTokens.color.bg.sidebarActive,
    "--mpa-color-bg-sidebar-hover": canopyTokens.color.bg.sidebarHover,
    ...
    "--mpa-color-border-sidebar-accent": canopyTokens.color.border.sidebarAccent,

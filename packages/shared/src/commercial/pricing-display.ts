...
export const PUBLIC_PRICING_MODEL_COPY = {
  ...
  pmIncludes: `Up to ${UNIT_BLOCK_SIZE} managed units · Online rent collection — ACH, cards & tenant AutoPay`,
  foIncludes: `Up to ${UNIT_BLOCK_SIZE} managed units`,
  completeIncludes: `Up to ${UNIT_BLOCK_SIZE} managed units · Online rent collection — ACH, cards & tenant AutoPay`,

...
> = {
  mpa_property_manager: {
    ...
    description:
      "Property operations for residential portfolios — properties and units, residents and leases, Tenant Portal, maintenance, vendors, documents and tables, reports, communications, and operational finance. Take rent online with Stripe."
  },
  mpa_facility_operations: {
  ...
  mpa_complete_platform: {
    ...
    description:
      "One organization and one subscription that includes both Property Operations and Facility Operations. Oversee both yourself, assign each side to a manager, keep an owner view of both, and move between work surfaces with the Complete launcher. Take rent online with Stripe when you operate in residential / property scope."
  }
};

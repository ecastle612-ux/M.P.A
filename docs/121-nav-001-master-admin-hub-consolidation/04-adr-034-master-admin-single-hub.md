...
## References
- [NAV-001 review](./01-navigation-simplification-review.md)  
- [NAV-001 design package](./02-design-package.md)  
- Canonical ADR copy: [ADR-034](../18-decision-log/adr-034-master-admin-single-hub.md)  

...
- Exit inventory E01–E13 closed  
- In-app document/report viewer (blob + CSP frame-src)  
- Stripe confirm + absolute returns + return banner  
- E-sign confirm + same-window  
- Auth deep-link notes  

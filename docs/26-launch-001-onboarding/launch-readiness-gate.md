...
Onboarding decision: **GO WITH OBSERVATIONS** — see [GO / NO-GO](./production-certification/go-no-go.md) · [Validation Sprint 1](./production-validation-sprint-1/index.md).

...
## Status
Accepted (amendment **Proposed** — 2026-08-13 beta invitation revision)
...
## Amendment (Proposed)
2026-08-13 — Replace direct account provisioning with customer-style **invitation → signup/login → Guided Setup → ACTIVE grant** beta workflow. Tester lifecycle: `INVITED` | `ACTIVE` | `EXPIRED` | `REVOKED`. Material change; Implement only after docs/76 re-Approve and this amendment is Accepted.
...
10. Material scope changes restart Design → Document → Approve. The invitation/lifecycle amendment is not implementable until **Accepted** and docs/76 is **Approved** again.

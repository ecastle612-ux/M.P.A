...
| [ADR-034](./adr-034-fin-ops-production-lineage-cutover.md) | FIN-OPS Production Lineage Cutover | **Accepted** | 2026-08-15 |
| [ADR-035](./adr-035-fin-ops-m2-identity-and-per-org-backfill.md) | FIN-OPS M2 Proven Unit Materialization and Per-Org Fail-Closed Backfill | **Proposed** | 2026-08-16 |

...
An **application deployment** package for Slices B and C only, after separate Owner authorization. Slice A grants are already live. Do not re-apply this migration. Do not deploy from this record.

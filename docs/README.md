...
| 65 | [Production pricing audit](./65-production-pricing-and-product-readiness-audit.md) | Live Stripe inventory + $40 reduction readiness |
| 65b | [Pricing migration preparation](./65-production-pricing-migration-preparation/index.md) | Prep only · NEW Prices pending operator |

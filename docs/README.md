...
| 118 | [PLAT-005 Privileged RPC Execute Hardening](./118-plat-005-privileged-rpc-execute-hardening/index.md) | **Draft / Proposed** · schema-only REVOKE design · parent PLAT-004 H6 · no implementation |

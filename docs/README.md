...
| 30 | [BUG-002 Production Deployment Verification](./30-bug-002-production-deployment-verification/index.md) | Production serves main without BUG-001; merge PR #44 required |

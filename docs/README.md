...
| 179 | [Pre-Marketing P1 Product Cleanup](./179-pre-marketing-p1-cleanup/index.md) | **Implemented** · P1-01–P1-07 closed · Production live — see 182 |
| 180 | [Final Pre-Marketing Readiness (P1-08 / P1-09 / P1-10)](./180-final-pre-marketing-readiness/index.md) | **Approved** · implemented · Production live — see 182 |
| 181 | [Final Pre-Marketing Readiness Implementation Certification](./181-final-pre-marketing-readiness-implementation-certification/index.md) | **Implemented / certified** · Production released — see 182 |
| 182 | [Final Pre-Marketing Production Release Certification](./182-final-pre-marketing-production-release-certification/index.md) | **READY FOR FINAL SUBSCRIPTION UAT** · Production `564aaf25` · stamp `20260817041817` |
...
| [179 Pre-marketing P1 cleanup](./179-pre-marketing-p1-cleanup/index.md) | **Implemented** — P1-01–P1-07 closed; Production live — see 182 |
| [180 Final pre-marketing readiness](./180-final-pre-marketing-readiness/index.md) | **Approved** — P1-08/P1-09/P1-10 design |
| [181 Final pre-marketing implementation certification](./181-final-pre-marketing-readiness-implementation-certification/index.md) | **Implemented / certified** — in-repo package; Production in 182 |
| [182 Final pre-marketing Production release](./182-final-pre-marketing-production-release-certification/index.md) | **READY FOR FINAL SUBSCRIPTION UAT** — SHA `564aaf25`; stamp `20260817041817` |

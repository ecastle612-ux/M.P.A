...
| 109 | [FAC-003 Production UAT Remediation Design](./109-fac-003-production-uat-remediation/index.md) | **DESIGN COMPLETE — APPROVAL REQUIRED** · RLS RETURNING + optional notify · ADR-029 Proposed · no implement |

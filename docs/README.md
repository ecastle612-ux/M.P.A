...
| 183 | [Final Controlled Subscription UAT Certification](./183-final-controlled-subscription-uat-certification/index.md) | **BLOCKED — SUBSCRIPTION UAT** · live Stripe; test card cannot complete |
...
| [183 Final controlled subscription UAT](./183-final-controlled-subscription-uat-certification/index.md) | **BLOCKED — SUBSCRIPTION UAT** — Production Checkout is Stripe live (`cs_live_`); test card cannot complete |

...
| 123 | [PLAT-006 Production Migration Certification](./123-plat-006-production-migration-certification/index.md) | **READY FOR PRODUCTION MIGRATION APPLICATION** · read-only baseline · applied in [124](./124-plat-006-production-migration-application-certification/index.md) |
| 124 | [PLAT-006 Slice A Production Migration Application Certification](./124-plat-006-production-migration-application-certification/index.md) | **READY FOR APPLICATION DEPLOYMENT** · grants live `20260815175833` · app still `e56a330f` · no deploy |

...
| 229 | [SEC-001 Final Auth Controls Recertification](./229-sec-001-final-auth-controls-production-recertification/index.md) | **BLOCKED — SEC-001 FINAL AUTH CONTROLS** · Auth min length now 12 · leaked-password 402 on Free plan · operator TOTP still 0 · no new deploy |
...
| [229 SEC-001 Final Auth Controls Recertification](./229-sec-001-final-auth-controls-production-recertification/index.md) | **BLOCKED — SEC-001 FINAL AUTH CONTROLS** — Stage 2 intact · publishable key rejected · operator TOTP still 0 · no new deploy |

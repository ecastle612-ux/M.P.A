...
| 83 | [First Production User Acceptance Test](./83-first-production-user-acceptance-test/index.md) | **BLOCKED** — `main` @ `dac469a` live; unauthenticated media/API deny pass; authenticated FO work-order + media UAT AUTH_BLOCKED (no `MPA_UAT_*` secrets) |

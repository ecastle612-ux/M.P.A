...
| 229 | [SEC-001 Final Auth Controls Recertification](./229-sec-001-final-auth-controls-production-recertification/index.md) | **BLOCKED — SEC-001 FINAL AUTH CONTROLS** · Stage 2 intact · supplied token was publishable key · operator TOTP still 0 · no new deploy |

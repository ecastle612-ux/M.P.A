...
| 76 | [ADM-001 Complimentary Access](./76-adm-001-complimentary-access/index.md) | **Draft revision** · beta invitation workflow · awaiting re-Approve |
| 77 | [ADM-001 Implementation Certification](./77-adm-001-implementation-certification/index.md) | Prior cert · onboarding semantics superseded by docs/76 revision |

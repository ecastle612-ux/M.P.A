...
| 102 | [FAC-003 Asset & Inventory Management Design](./102-fac-003-asset-inventory-management/index.md) | **Draft** · FO asset registry + stock ledger · ADR-028 Proposed · no implement |

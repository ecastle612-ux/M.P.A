...
| 50 | [API-004 Electronic Signatures](./50-api-004-electronic-signatures/README.md) | SignatureService / SignWell platform (Approved · Implemented · ADR-030) |
...
| 110 | [COM-001 Customer Lifecycle & Commercial Operations](./110-com-001-customer-lifecycle-commercial-operations/README.md) | Lead → customer → renew/cancel (**Approved with Amendments** · A10 Draft self-serve) |
...
| 119 | [STD-001 UX-016 Platform Standards](./119-std-001-ux016-platform-standards/README.md) | Permanent dashboard · navigation · design · inheritance law (**Accepted**) · [Admin audit](./119-std-001-ux016-platform-standards/06-admin-surface-compliance-audit.md) · [Operational workspace audit](./119-std-001-ux016-platform-standards/10-operational-workspace-compliance-audit.md) |

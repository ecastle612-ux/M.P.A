...
| 138 | [Complete Invitation Remediation Production Migration Application Certification](./138-complete-delegated-operations-invitation-production-migration-application-certification/index.md) | **READY FOR APPLICATION DEPLOYMENT** · schema live `20260815222252` · app still `9b92db37` · no deploy |
...
| [138 Invitation Production Migration Application Certification](./138-complete-delegated-operations-invitation-production-migration-application-certification/index.md) | **READY FOR APPLICATION DEPLOYMENT** · schema live · no deploy |
...
| [138 Production migration application certification](./138-complete-delegated-operations-invitation-production-migration-application-certification/index.md) | **READY FOR APPLICATION DEPLOYMENT** · schema live `20260815222252` · no deploy |

...
| [146 FIN-OPS M2 compatibility amendment](./146-fin-ops-production-reconciliation-m2-compatibility-amendment/index.md) | **DESIGN COMPLETE — APPROVAL REQUIRED** — currency USD default; proven `units` materialization; no per-org cutover |
| [ADR-034](./18-decision-log/adr-034-fin-ops-production-lineage-cutover.md) | Accepted — Production lineage cutover |
| [ADR-035](./18-decision-log/adr-035-fin-ops-m2-identity-and-per-org-backfill.md) | Proposed — proven unit materialization + per-org fail-closed M2 backfill |

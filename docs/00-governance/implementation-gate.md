...
| CORE-004 Core Platform Expansion | ✅ **APPROVED** · Phase 1 ✅ Accepted · Phase 2 ✅ Certified · Phase 3+ locked until Accept + Authorize ([120](../120-core-004-core-platform-expansion/README.md) · [ADR-035](../18-decision-log/adr-035-core-004-core-platform-expansion.md) · [Phase 2 cert](../120-core-004-core-platform-expansion/14-phase-2-certification.md)) |

...
| EP-019 Performance & Speed Certification | **Paused** · ❌ Not Approved · Implement **locked** · Blocker 6 **QUEUED** · [Blocker-6-Readiness](../103-core-002-commercial-launch-blocker-execution/Blocker-6-Readiness.md) ([87](../87-ep-019-performance-speed-certification/README.md)) |
...
| CORE-004 Core Platform Expansion | ✅ **APPROVED** · Phase 1 ✅ Certified · Phase 2+ locked until Authorize ([120](../120-core-004-core-platform-expansion/README.md) · [ADR-035](../18-decision-log/adr-035-core-004-core-platform-expansion.md) · [Phase 1 cert](../120-core-004-core-platform-expansion/10-phase-1-certification.md)) |

...
| Facility Operations features | **Approved** — FAC-OPS-001 ([design-package](../27-facility-operations/design-package/index.md)); ADR-018 **Accepted**. Phase **E.1 authorized**; E.2+ **NO-GO** until slice authorize. |

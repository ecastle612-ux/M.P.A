...
| Facility Operations features | **Design Documented (Proposed)** — FAC-OPS-001 ([design-package](../27-facility-operations/design-package/index.md)); ADR-018 Proposed. **Implement NO-GO** until Approve + Phase E.x authorize. Shells already shipped. |

...
| Complete Delegated Operations (ADR-033) | Design Approved / ADR-033 Accepted. Production schema live `20260815185722` — [docs/129](../129-complete-delegated-operations-production-migration-application/index.md) **READY FOR APPLICATION DEPLOYMENT**. Data-plane remainder [docs/130](../130-complete-delegated-operations-dataplane-scope/index.md) **Proposed**. Application still `44d50bf1`. **No deploy. No FIN-OPS.** |

...
| **CORE-003** | ✅ **APPROVED** (2026-07-23) | M0 ✅ **GO** · UX-A ✅ **VALIDATED** · OPS-A ✅ **AUTHORIZED** ([39](../113-core-003-implementation-master-plan/39-ops-001-slice-a-authorization.md)) | N/A (governance) | COM/AUTH/FIN/OPS/PMX/UX (+ PAY-001 Verified) | Product + Architect + CTO | Implement OPS-001 Slice A → `VALIDATE OPS-001 SLICE A` |
...
| **OPS-001** | ✅ **Approved with Amendments** | Slice A ✅ **AUTHORIZED** · B–E 🔒 | Slice A implement pending · [30](../111-ops-001-platform-operations-architecture/30-slice-a-authorization.md) | ADR-005, ADR-028, MHF-001, API-001, EML-001, **CORE-003**, UX-012 A Validated | Product + Architect + Platform | Implement Slice A → `VALIDATE OPS-001 SLICE A` → then AUTH-001 A |
| **UX-012** | ✅ **Approved with Amendments** | Slice A ✅ **VALIDATED** · B–E 🔒 | [32](../112-ux-012-platform-experience-design-system/32-slice-a-validation.md) | Canopy Approved, OPS-001, ADR-029, UI-001 inherits, **CORE-003** | Product + UX + Architect | `AUTHORIZE OPS-001 SLICE A` (default) and/or `AUTHORIZE UX-012 SLICE B` |

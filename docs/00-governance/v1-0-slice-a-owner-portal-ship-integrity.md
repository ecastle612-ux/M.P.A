...
**Status:** 🟢 **SHIPPED TO PRODUCTION** — authorized 2026-07-25 · deploy `463f18e`  
...
| Field | Value |
|-------|-------|
| Git SHA | `463f18e0fd6bc0c8113291ca5182c2d02318933f` |
| Production | https://www.my-property-assistant.com |
| Deployment | `dpl_B3KSunoRx1tbTKiqCLKWaokAHdtZ` |
...
5. ⏳ Owner role path smoke (login → `/portal/owner` → one secondary section) — **manual**

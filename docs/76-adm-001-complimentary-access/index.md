...
**Related ADR:** [ADR-022](../18-decision-log/adr-022-master-admin-complimentary-access.md) (Accepted; amendment Accepted)  
**Production:** NO DEPLOYMENT from this package  
**Authorization:** Product Owner implementation authorization for beta invitation workflow  

**Revision note:** Customer-style invitation → signup/login → Guided Setup → Mission Control beta path. Prior direct-provision cert (docs/77) onboarding semantics superseded.
...
| Item | Status |
|------|--------|
| Design revision (invitation beta flow) | **Complete** |
| Document | **This record** |
| Approve | **Approved** |
| ADR-022 amendment | **Accepted** |
| Application code | See docs/78 implementation certification |
...
- [x] Product Owner approves invitation → Guided Setup beta workflow  
- [x] Architect accepts ADR-022 amendment (lifecycle + invite activation)  
- [x] Security model documented  
- [x] Status on this doc → **Approved**  
- [ ] Production deploy — Owner-authorized release only
